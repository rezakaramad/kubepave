...
locals {
  ...
  network_name        = "management-default"
  network_subnet_name = "management-default"
  project_ids = {
  ...
  folder_ids = {
    ...
    "tenant_environments"   = "5374651098"
  }
}
...
terraform {
  backend "gcs" {
    bucket = "gke-management-tfstate-h4suzz"
    prefix = "default"
