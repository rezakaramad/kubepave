...
# -----------------------------------------------------------------------------
init_secrets() {
  # Skip generation if the secrets file already exists
  ...
  # Generate random credentials for PowerDNS database and API key
  local db_password api_key
  db_password="$(openssl rand -base64 24 | tr -d '=')"
  api_key="$(openssl rand -base64 24 | tr -d '=')"

  # Write the credentials to the secrets file in a format suitable for sourcing
...
# -----------------------------------------------------------------------------
# Load PowerDNS secrets from '.powerdns.env' into the environment.
# -----------------------------------------------------------------------------
load_secrets() {
